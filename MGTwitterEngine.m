...
- (NSString *)getUserInformationFor:(NSString *)screenName
{
    if (!screenName) {
        return nil;
    }
    NSString *path = [NSString stringWithFormat:@"users/show.%@?screen_name=%@&include_entities=true",API_FORMAT, screenName];
